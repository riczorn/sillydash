...
<div class="card" style="max-width: 800px; margin: 0 auto;">
    ...
    <form action="<?= site_url('setup/attempt') ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="db_prefix" id="db_prefix" value="<?= old('db_prefix', 'silly_') ?>">
        </div>

        <div class="form-group">
            <label for="list_folder">List Folder Path (Absolute or Relative to utils)</label>
            <input type="text" name="list_folder" id="list_folder" value="<?= old('list_folder', './files') ?>">
        </div>

        <div class="form-group">
            <label for="cron_token">Cron Token</label>
            <input type="text" name="cron_token" id="cron_token" value="<?= old('cron_token', 'super-secret-token') ?>">
            <small style="display:block; margin-top:0.3rem; color:var(--text-muted); font-size:0.8rem;">
        ...
        <div class="form-group">
            ...
            <input type="text" name="admin_user" id="admin_user" value="<?= old('admin_user', 'admin') ?>" required>
        </div>
        <div class="form-group">
